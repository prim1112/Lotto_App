...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 01, 2024 at 03:56 PM
...
CREATE TABLE `lottery_number` (
  ...
  `lottery_num` varchar(50) DEFAULT NULL,
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`lottery_id`) REFERENCES `lottery_number` (`lottery_id`);
COMMIT;
